    ...
    return LaunchDescription([
        ...
        TimerAction(
            ...
            arguments=[
                ...
                '/world/baylands/model/x500_lidar_camera_0/link/pitch_link/sensor/camera/image@sensor_msgs/msg/Image[gz.msgs.Image',
                '/world/baylands/model/x500_lidar_camera_0/link/pitch_link/sensor/camera/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo',
                ...
                '/world/baylands/model/x500_lidar_camera_0/link/base_link/sensor/imu_sensor/imu@sensor_msgs/msg/Imu[gz.msgs.IMU',
                '/world/baylands/model/x500_lidar_camera_0/link/base_link/sensor/air_pressure_sensor/air_pressure@sensor_msgs/msg/FluidPressure[gz.msgs.FluidPressure',
                '/navsat@sensor_msgs/msg/NavSatFix[gz.msgs.NavSat',
                
                    # All sensor and control topics
                    ],
                    remappings=[
                        ('/world/baylands/model/x500_lidar_camera_0/link/pitch_link/sensor/camera/image', ns + '/gimbal_camera'),
                        ('/world/baylands/model/x500_lidar_camera_0/link/pitch_link/sensor/camera/camera_info', ns + '/gimbal_camera_info'),
                        ...
                        ('/world/baylands/model/x500_lidar_camera_0/link/base_link/sensor/imu_sensor/imu', ns + '/imu'),
                        ('/world/baylands/model/x500_lidar_camera_0/link/base_link/sensor/air_pressure_sensor/air_pressure', ns + '/air_pressure'),
                        ('/navsat', ns + '/gps'),
                    ]
                ),
            ]
